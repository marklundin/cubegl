...
TWEEN.Tween=function(a){var b={},c={},d={},e=1E3,f=0,h=!1,g=!1,m=0,s=null,r=TWEEN.Easing.Linear.None,p=TWEEN.Interpolation.Linear,l=[],k=null,u=!1,A=null,q=null,w;for(w in a)b[w]=parseFloat(a[w],10);this.to=function(a,b){void 0!==b&&(e=b);c=a;return this};this.start=function(e){TWEEN.add(this);g=!0;u=!1;s=void 0!==e?e:"undefined"!==typeof window&&void 0!==window.performance&&void 0!==window.performance.now?window.performance.now():Date.now();s+=m;for(var f in c){if(c[f]instanceof Array){if(0===c[f].length)continue;
c[f]=[a[f]].concat(c[f])}b[f]=a[f];!1===b[f]instanceof Array&&(b[f]*=1);d[f]=b[f]||0}return this};this.stop=function(){if(!g)return this;TWEEN.remove(this);g=!1;this.stopChainedTweens();return this};this.stopChainedTweens=function(){for(var a=0,b=l.length;a<b;a++)l[a].stop()};this.delay=function(a){m=a;return this};this.repeat=function(a){f=a;return this};this.yoyo=function(a){h=a;return this};this.easing=function(a){r=a;return this};this.interpolation=function(a){p=a;return this};this.chain=function(){l=
arguments;return this};this.onStart=function(a){k=a;return this};this.onUpdate=function(a){A=a;return this};this.onComplete=function(a){q=a;return this};this.update=function(g){var n;if(g<s)return!0;!1===u&&(null!==k&&k.call(a),u=!0);var v=(g-s)/e,v=1<v?1:v,t=r(v);for(n in c){var w=b[n]||0,z=c[n];z instanceof Array?a[n]=p(z,t):("string"===typeof z&&(z=w+parseFloat(z,10)),"number"===typeof z&&(a[n]=w+(z-w)*t))}null!==A&&A.call(a,t);if(1==v)if(0<f){isFinite(f)&&f--;for(n in d)"string"===typeof c[n]&&
(d[n]+=parseFloat(c[n],10)),h&&(v=d[n],d[n]=c[n],c[n]=v),b[n]=d[n];s=g+m}else{null!==q&&q.call(a);n=0;for(v=l.length;n<v;n++)l[n].start(g);return!1}return!0}};
...
c--}}else b instanceof ERNO.Direction?a[c]=b.initial:b instanceof Array?(d=a.slice(0,c),h=a.slice(c+1),a=d.concat(b,h)):a.splice(c,1),c--;return a};ERNO.Cubelet=function(a,b,c){THREE.Object3D.call(this);this.cube=a;this.id=b||0;this.setAddress(this.id);this.size=a.cubeletSize||140;a=this.addressX*(this.size+0);b=this.addressY*(this.size+0);var d=this.addressZ*(this.size+0);this.position.set(a,b,d);this.matrixSlice=(new THREE.Matrix4).makeTranslation(a,b,d);this.updateMatrix();this.cube.object3D.add(this);a=0;void 0===c&&(c=[W,O,,,G]);this.faces=[];for(b=0;6>b;b++)d=c[b]||ERNO.COLORLESS,this.faces[b]={},this.faces[b].id=b,this.faces[b].color=
...
var s=b.cubelets.slice();h.makeRotationAxis(this.axis,-1*m);for(var r=a.length,p;0<r--;)p=b.cubelets[a[r]],e.set(p.addressX,p.addressY,p.addressZ),f.copy(e),e.multiply(c).applyMatrix4(h),e.x=Math.round(e.x),e.y=Math.round(e.y),e.z=Math.round(e.z),e.add(f.multiply(this.axis)),e.add(d),e.y=2-e.y,e.z=2-e.z,b.cubelets[p.address]=s[9*e.z+3*e.y+e.x];for(r=0;r<b.cubelets.length;r++)b.cubelets[r].setAddress(r);h.makeRotationAxis(this.axis,m);this.cubelets.forEach(function(a){g=[];a.faces.forEach(function(a,
...
ERNO.extend(ERNO.Slice.prototype,{get origin(){return this.getCubelet(4)},get north(){return this.getCubelet(1)},get northEast(){return this.getCubelet(2)},get east(){return this.getCubelet(5)},get southEast(){return this.getCubelet(8)},get south(){return this.getCubelet(7)},get southWest(){return this.getCubelet(6)},get west(){return this.getCubelet(3)},get northWest(){return this.getCubelet(0)},get cubelets(){for(var a=[],b=this.indices.length;0<b--;)a.push(this.getCubelet(b));return a},map:function(a,
b){for(var c=0;6>c;c++)if(this.origin.faces[c].color&&this.origin.faces[c].color!==ERNO.COLORLESS){this.color=this.origin.faces[c].color;this.face=ERNO.Direction.getNameById(c);break}if(void 0===this.axis||0===this.axis.lengthSq()){var c=this.northEast.position.clone(),d=this.southWest.position.clone(),e=this.northWest.position.clone();this.axis=(new THREE.Vector3).crossVectors(d.sub(c),e.sub(c)).normalize();this.axis.rotation=0}this.up=new ERNO.Group(this.northWest,this.north,this.northEast);this.equator=
new ERNO.Group(this.west,this.origin,this.east);this.down=new ERNO.Group(this.southWest,this.south,this.southEast);this.left=new ERNO.Group(this.northWest,this.west,this.southWest);this.middle=new ERNO.Group(this.north,this.origin,this.south);this.right=new ERNO.Group(this.northEast,this.east,this.southEast);(c=this.hasType("center"))&&1===c.cubelets.length?(this.center=this.hasType("center"),this.corners=new ERNO.Group(this.hasType("corner")),this.cross=new ERNO.Group(this.center,this.hasType("edge")),
this.ex=new ERNO.Group(this.center,this.hasType("corner"))):this.centers=new ERNO.Group(this.hasType("center"));this.edges=new ERNO.Group(this.hasType("edge"));this.ring=new ERNO.Group(this.northWest,this.north,this.northEast,this.west,this.east,this.southWest,this.south,this.southEast);this.dexter=new ERNO.Group(this.northWest,this.origin,this.southEast);this.sinister=new ERNO.Group(this.northEast,this.origin,this.southWest);return this},set rotation(a){if(this.ableToHideInternalFaces&&this.cube.hideInvisibleFaces){var b=
0!==a%(0.5*Math.PI);this.invertedAxis.copy(this.axis).negate();b?this.neighbour?(this.showIntroverts(this.axis,!0),this.neighbour.showIntroverts(this.invertedAxis,!0)):(this.cube.showIntroverts(this.axis,!0),this.cube.showIntroverts(this.invertedAxis,!0)):this.neighbour?(this.hideIntroverts(null,!0),this.neighbour.hideIntroverts(null,!0)):this.cube.hideIntroverts(null,!0)}this.matrix.makeRotationAxis(this.axis,a);this.axis.rotation=a;a=this.indices.length;for(var c=new THREE.Matrix4;a--;)b=this.getCubelet(a),
b.matrix.multiplyMatrices(this.matrix,b.matrixSlice),b.position.setFromMatrixPosition(b.matrix),b.scale.setFromMatrixScale(b.matrix),c.extractRotation(b.matrix),b.quaternion.setFromRotationMatrix(c)},get rotation(){return this.axis.rotation},getLocation:function(a){return a===this.origin?"origin":a===this.north?"north":a===this.northEast?"northEast":a===this.east?"east":a===this.southEast?"southEast":a===this.south?"south":a===this.southWest?"southWest":a===this.west?"west":a===this.northWest?"northWest":
...
ERNO.Fold.prototype.getText=function(){var a="";this.map.forEach(function(b){a+=b.innerHTML});return a};ERNO.Fold.prototype.setText=function(a){var b;a=a.justifyLeft(18);for(b=0;18>b;b++)this.map[b].innerHTML=a.substr(b,1)};ERNO.Projector=function(){return function(a,b){function c(a,b){k.getInverse(b.projectionMatrix);f.multiplyMatrices(b.matrixWorld,k);return a.applyProjection(f)}function d(d,f,k){var x=b,n=x!==document?x.getBoundingClientRect():{left:0,top:0,width:window.innerWidth,height:window.innerHeight};x!==document&&(x=x.ownerDocument.documentElement,n.left+=window.pageXOffset-x.clientLeft,n.top+=window.pageYOffset-x.clientTop);e=n;g.x=(f-e.left)/e.width*2-1;g.y=(k-e.top)/e.height*-2+1;g.z=-1;m.set(g.x,g.y,1);
c(g,d);c(m,d);m.sub(g).normalize();r.set(g,m);h.getInverse(a.matrixWorld);r.applyMatrix4(h);return r}var e,f=new THREE.Matrix4,h=new THREE.Matrix4,g=new THREE.Vector3,m=new THREE.Vector3(1,1,1),s=new THREE.Vector3,r=new THREE.Ray,p=new THREE.Box3,l=new THREE.Sphere,k=new THREE.Matrix4,u=g.distanceTo(m);p.min.set(0.5*-a.size,0.5*-a.size,0.5*-a.size);p.max.set(0.5*a.size,0.5*a.size,0.5*a.size);l.radius=u*a.size*0.5;return{getIntersection:function(b,c,e,f,g){f=f||new THREE.Vector3;if(null===c||null===
e)return null;d(b,c,e);return r.isIntersectionSphere(l)&&null!==r.intersectBox(p,f)?(g&&(b=s||new THREE.Vector3,b.copy(f).set(Math.round(b.x),Math.round(b.y),Math.round(b.z)).multiplyScalar(2/a.size).set(b.x|0,b.y|0,b.z|0),g.setFromNormalAndCoplanarPoint(s,f)),f):null},getIntersectionOnPlane:function(a,b,c,e,f){if(null===b||null===c)return null;d(a,b,c);return r.intersectPlane(e,f)},getCubeletAtIntersection:function(){var b=new THREE.Vector3;return function(c){b.copy(c).add(p.max).multiplyScalar(3/
a.size).set(Math.min(b.x|0,2),Math.min(3-b.y|0,2),Math.min(3-b.z|0,2));return a.cubelets[9*b.z+3*b.y+b.x]}}()}}}();ERNO.Interaction=function(){return function(a,b,c,d,e){function f(c){null!=c.touches&&c.preventDefault();y.enabled&&2!==c.button&&(k=(c.touches&&c.touches[0]||c).clientX,u=(c.touches&&c.touches[0]||c).clientY,m.getIntersection(b,k,u,s,w)&&0===a.isTweening()&&(z="undefined"!==typeof window&&void 0!==window.performance&&void 0!==window.performance.now?window.performance.now():Date.now(),y.active=!0,r=m.getCubeletAtIntersection(s),p=[a.slices[r.addressX+1],a.slices[r.addressY+4],a.slices[r.addressZ+
7]],document.addEventListener("mousemove",h),document.addEventListener("touchmove",h),document.addEventListener("mouseup",g),document.addEventListener("touchcancel",g),document.addEventListener("touchend",g),document.removeEventListener("mousedown",f),document.removeEventListener("touchstart",f)))}function h(a){y.active&&(v.x=(a.touches&&a.touches[0]||a).clientX,v.y=(a.touches&&a.touches[0]||a).clientY);y.enabled&&(a.preventDefault(),a.stopImmediatePropagation())}function g(b){var c=(b.touches&&b.touches[0]||
b).clientX;b=(b.touches&&b.touches[0]||b).clientY;y.active=!1;y.enabled&&(c!==u||b!==u)&&q&&(c=l.name[0].toUpperCase(),b=Math.round(E/Math.PI*2)*Math.PI*0.5,0.3<x.length()/(("undefined"!==typeof window&&void 0!==window.performance&&void 0!==window.performance.now?window.performance.now():Date.now())-z)&&(b=Math.floor(E/Math.PI*2)*Math.PI*0.5,b+=0<n.dot(x.normalize())?0.5*Math.PI:0),a.twist(new ERNO.Twist(c,b.radiansToDegrees())));z=0;v.x=void 0;v.y=void 0;q=!1;l=null;document.removeEventListener("mousemove",
h);document.removeEventListener("touchmove",h);document.removeEventListener("mouseup",g);document.removeEventListener("touchend",g);document.removeEventListener("touchcancel",g);document.addEventListener("mousedown",f);document.addEventListener("touchstart",f)}var m=new ERNO.Projector(a,c),s=new THREE.Vector3,r,p,l,k,u,A=new THREE.Vector3,q=!1,w=new THREE.Plane,x=new THREE.Vector3,n=new THREE.Vector3,v=new THREE.Vector2;new THREE.Vector3;var t=new THREE.Vector3,E=0,z=0;v.x=void 0;v.y=void 0;var y=
{active:!1,enabled:!0,multiDrag:e||!1,multiDragSnapArea:100,dragSpeed:d||1.3};THREE.EventDispatcher.prototype.apply(y);y.getIntersectionAt=function(){var a=new THREE.Vector3,c=new THREE.Plane;return function(d,e){return null===m.getIntersection(b,d,e,a,c)?null:{cubelet:m.getCubeletAtIntersection(a),face:1===c.normal.x?"RIGHT":-1===c.normal.x?"LEFT":1===c.normal.y?"UP":-1===c.normal.y?"DOWN":1===c.normal.z?"FRONT":"BACK"}}}();y.update=function(){var c=v.x,d=v.y;y.enabled&&y.active&&void 0!==c&&void 0!=
d&&(k!==c||u!==d)&&(m.getIntersectionOnPlane(b,c,d,w,A),x.subVectors(A,s),!q&&5<x.length()&&(l&&(l.rotation=0),q=!0,t.crossVectors(w.normal,x),c=Math.max(Math.abs(t.x),Math.abs(t.y),Math.abs(t.z)),t.x=t.x/c|0,t.y=1===t.x?0:t.y/c|0,t.z=1===t.x||1===t.y?0:t.z/c|0,l=p[Math.abs(3*t.z+2*t.y+t.x)-1],n.crossVectors(l.axis,w.normal).normalize()),q&&(x.subVectors(A,s),E=n.dot(x)/a.size*y.dragSpeed),l&&(l.rotation=E))};document.addEventListener("mousedown",f);document.addEventListener("touchstart",f);var F=
function(a,b){var c=this.getIntersectionAt(a,b);c&&this.dispatchEvent(new CustomEvent("click",{detail:c}))}.bind(y),C,D;c.addEventListener("mousedown",function(a){C=a.clientX;D=a.clientY});c.addEventListener("mouseup",function(a){var b=a.clientX;a=a.clientY;Math.abs(Math.sqrt((b-C)*(b-C)+(a-D)*(a-D)))<10*(window.devicePixelratio||1)&&F(C,D)});c.addEventListener("touchstart",function(a){a.preventDefault();C=a.touches[0].clientX;D=a.touches[0].clientY});c.addEventListener("touchend",function(a){var b=
a.changedTouches[0].clientX;a=a.changedTouches[0].clientY;Math.abs(Math.sqrt((b-C)*(b-C)+(a-D)*(a-D)))<10*(window.devicePixelratio||1)&&F(C,D)});return y}}();ERNO.Controls=function(){var a,b;a=0;b=1;return function(c,d,e){function f(b){q.enabled&&1===b.which&&null===A.getIntersection(d,b.pageX,b.pageY)&&(p=a,l.multiplyScalar(0),w(b.pageX,b.pageY,k),u.copy(k),q.domElement.removeEventListener("mousedown",f),document.addEventListener("mousemove",h),document.addEventListener("mouseup",g))}function h(b){q.enabled&&(b.preventDefault(),p=a,w(b.pageX,b.pageY,k),l.subVectors(k,u),u.copy(k))}function g(a){document.removeEventListener("mousemove",h);document.removeEventListener("mouseup",
g);q.domElement.addEventListener("mousedown",f);q.enabled&&(p=b)}function m(b){q.enabled&&null===A.getIntersection(d,b.touches[0].pageX,b.touches[0].pageY)&&(p=a,l.multiplyScalar(0),w(b.touches[0].pageX,b.touches[0].pageY,k),u.copy(k),q.domElement.removeEventListener("touchstart",m),document.addEventListener("touchend",r),document.addEventListener("touchmove",s))}function s(b){q.enabled&&(p=a,w(b.changedTouches[0].pageX,b.changedTouches[0].pageY,k),l.subVectors(k,u),u.copy(k))}function r(a){document.removeEventListener("touchend",
r);document.removeEventListener("touchmove",s);q.domElement.addEventListener("touchstart",m);q.enabled&&(p=b)}var p=-1,l=new THREE.Vector2,k=new THREE.Vector2;new THREE.Vector2;var u=new THREE.Vector2,A=new ERNO.Projector(c,e),q={enabled:!0,domElement:e,rotationSpeed:4,damping:0.25},w=function(a,b,c){var d;d=q.domElement;d=d!==document?d.getBoundingClientRect():{left:0,top:0,width:window.innerWidth,height:window.innerHeight};var e=window.devicePixelRatio||1;return c.set(0.0010*(a*e-d.width-d.left),
0.0010*(d.height+d.top-b*e))};q.update=function(){var e=new THREE.Vector3,f=0,g=new THREE.Matrix4;return function(){!1!==q.enabled&&-1!==p&&(e.set(l.y,-1*l.x,0).normalize(),g.getInverse(c.matrixWorld),g.multiply(d.matrixWorld),e.transformDirection(g),l.multiplyScalar(1-Math.max(0,Math.min(1,q.damping))),f=l.length(),c.object3D.rotateOnAxis(e,-f*q.rotationSpeed),p===a?p=-1:p===b&&1E-4<=f?k.add(l):p=-1)}}();q.domElement.addEventListener("mousedown",f);q.domElement.addEventListener("touchstart",m);return q}}();var SceneType=THREE.Scene;THREE.Scene=SceneType||function(){};ERNO.renderers=ERNO.renderers||{};
...
g=new THREE.Object3D;g.add(b.object3D);g.add(b.camera);var m;new THREE.Vector3;b.faces.forEach(function(a,c){m=b[a.face].label=new THREE.CSS3DObject(document.createElement("div"));m.element.classList.add("faceLabel");m.position.copy(a.axis).multiplyScalar(b.size);m.position.negate();m.element.innerHTML=a.face.toUpperCase();b.object3D.add(m)});b.right.label.rotation.y=0.5*Math.PI;b.left.label.rotation.y=-0.5*Math.PI;b.back.label.rotation.y=Math.PI;b.up.label.rotation.x=-0.5*Math.PI;b.down.label.rotation.x=
0.5*Math.PI;b.showFaceLabels=function(){e().forEach(c);this.showingFaceLabels=!0;return this};b.hideFaceLabels=function(){e().forEach(d);this.showingFaceLabels=!1;return this};ERNO.extend(ERNO.Cubelet.prototype,ERNO.renderers.CSS3DCubelet.methods);a.forEach(ERNO.renderers.CSS3DCubelet);requestAnimationFrame(f);SceneType&&(THREE.Scene=SceneType);return h};
...
"rotateY( -90deg ) translateZ( "+b+"px ) rotateZ( -90deg )","rotateY( 180deg ) translateZ( "+b+"px ) rotateZ( -90deg )"];a.faces.forEach(function(b){b.element=document.createElement("div");b.element.classList.add("face");b.element.classList.add("face"+ERNO.Direction.getNameById(b.id).capitalize());a.css3DObject.element.appendChild(b.element);var e=document.createElement("div");e.classList.add("wireframe");b.element.appendChild(e);e=document.createElement("div");e.classList.add("id");b.element.appendChild(e);
var f=document.createElement("span");f.classList.add("underline");f.innerText=a.id;e.appendChild(f);e=b.element.style;e.OTransform=e.MozTransform=e.WebkitTransform=e.transform=c[b.id];b.isIntrovert?(b.element.classList.add("faceIntroverted"),b.element.appendChild(document.createElement("div"))):(b.element.classList.add("faceExtroverted"),e=document.createElement("div"),e.classList.add("sticker"),e.classList.add(b.color.name),b.element.appendChild(e),a.isStickerCubelet&&e.classList.add("stickerLogo"),
e=document.createElement("div"),e.classList.add("text"),e.innerText=b.id,b.text=e,b.element.appendChild(e))});a.show();a.showIntroverts();a.showPlastics();a.showStickers();a.hideIds();a.hideTexts();a.hideWireframes()}}();
...
0,-1);this.cubelets.forEach(function(a,b){a.setAddress(b)});this.hideInvisibleFaces&&this.hideIntroverts(!0);this.renderer=b(this.cubelets,this);this.domElement=this.renderer.domElement;this.domElement.classList.add("cube");this.domElement.style.fontSize=this.cubeletSize+"px";this.object3D.add(this.autoRotateObj3D);this.mouseInteraction=new ERNO.Interaction(this,this.camera,this.domElement);this.mouseInteraction.addEventListener("click",function(a){this.dispatchEvent(new CustomEvent("click",{detail:a.detail}))}.bind(this));
this.controls=new (a.controls||ERNO.Controls)(this,this.camera,this.domElement);this.folds=[new ERNO.Fold(this.front,this.right),new ERNO.Fold(this.left,this.up),new ERNO.Fold(this.down,this.back)];this.setSize(400,200);this.loop=this.loop.bind(this);requestAnimationFrame(this.loop);document.addEventListener("keypress",function(a){"input"!==a.target.tagName.toLowerCase()&&"textarea"!==a.target.tagName.toLowerCase()&&!this.mouseInteraction.active&&this.keyboardControlsEnabled&&(a=String.fromCharCode(a.which),
0<="XxRrMmLlYyUuEeDdZzFfSsBb".indexOf(a)&&this.twist(a))}.bind(this))};ERNO.Cube.prototype=Object.create(ERNO.Group.prototype);ERNO.Cube.prototype.constructor=ERNO.Cube;
ERNO.extend(ERNO.Cube.prototype,{shuffle:function(a){a=a||30;var b=this.shuffleMethod.slice(),c,d=new ERNO.Twist,e;this.twistQueue.empty(!0);for(this.historyQueue.empty(!0);0<a--;){e=b.split("");for(c=(new ERNO.Twist).copy(d);c.equals(d);)c.set(e.splice(Math.floor(Math.random()*e.length),1)[0]);c.isShuffle=!0;this.twist(c);d=c.getInverse()}this.finalShuffle=c},solve:function(){this.isSolving=!0},isSolved:function(){return this.front.isSolved(ERNO.Direction.FRONT)&&this.up.isSolved(ERNO.Direction.UP)&&
this.right.isSolved(ERNO.Direction.RIGHT)&&this.down.isSolved(ERNO.Direction.DOWN)&&this.left.isSolved(ERNO.Direction.LEFT)&&this.back.isSolved(ERNO.Direction.BACK)},undo:function(){0<this.twistQueue.history.length&&(this.historyQueue.add(this.twistQueue.undo().getInverse()),this.undoing=!0)},redo:function(){0<this.twistQueue.future.length&&(this.undoing=!0,this.historyQueue.empty(),this.historyQueue.add(this.twistQueue.redo()))},twist:function(a){this.undoing&&this.twistQueue.empty();this.historyQueue.empty();
this.undoing=!1;this.twistQueue.add(a)},immediateTwist:function(a){0.8<=this.verbosity&&console.log("Executing a twist command to rotate the "+a.group+" "+a.wise+" by",a.degrees,"degrees.");for(var b=this.slicesDictionary[a.command.toLowerCase()],c=(void 0===a.degrees?90:a.degrees)*a.vector,d=c.degreesToRadians(),e=Math.abs(d-b.rotation)/(0.5*Math.PI)*this.twistDuration,f=b.indices.length,h;0<f--;)b.getCubelet(f).isTweening=!0;(new TWEEN.Tween(b)).to({rotation:d},e).easing(TWEEN.Easing.Quartic.Out).onComplete(function(){b.rotation=
d;b.axis.rotation=0;for(f=b.indices.length;0<f--;)h=b.getCubelet(f),h.isTweening=!1,h.updateMatrix(),h.matrixSlice.copy(h.matrix);0!==c&&(b.rotateGroupMappingOnAxis(d),this.dispatchEvent(new CustomEvent("onTwistComplete",{detail:{slice:b,twist:a}})));a===this.finalShuffle&&(this.finalShuffle=null,this.dispatchEvent(new CustomEvent("onShuffleComplete",{detail:{slice:b,twist:a}})))}.bind(this)).start(this.time)},getText:function(a){if(void 0===a)return[this.folds[0].getText(),this.folds[1].getText(),
this.folds[2].getText()];if(_.isNumeric(a)&&0<=a&&2>=a)return this.folds[a].getText()},setText:function(a,b){void 0===b?(this.folds[0].setText(a),this.folds[1].setText(a),this.folds[2].setText(a)):_.isNumeric(b)&&0<=b&&2>=b&&this.folds[b].setText(a)},setSize:function(a,b){this.camera.updateProjectionMatrix();this.renderer.setSize(a,b)},PRESERVE_LOGO:"RrLlUuDdSsBb",ALL_SLICES:"RrMmLlUuEeDdFfSsBb",EVERYTHING:"XxRrMmLlYyUuEeDdZzFfSsBb",loop:function(){var a=0;return function(){requestAnimationFrame(this.loop);
var b="undefined"!==typeof window&&void 0!==window.performance&&void 0!==window.performance.now?window.performance.now():Date.now(),c=b-(a||b);a=b;this.paused||(this.time+=c,TWEEN.update(this.time),this.autoRotate&&(this.rotation.x+=this.rotationDelta.x,this.rotation.y+=this.rotationDelta.y,this.rotation.z+=this.rotationDelta.z),this.isReady&&0===this.isTweening()&&(b=this.undoing?this.historyQueue:this.twistQueue,0===b.future.length?this.isSolving&&window.solver?this.isSolving=window.solver.consider(this):
!0===this.taskQueue.isReady&&(b=this.taskQueue.do(),b instanceof Function&&b()):(c=b.do(),"x"!==c.command.toLowerCase()&&"y"!==c.command.toLowerCase()&&"z"!==c.command.toLowerCase()&&0!==c.degrees&&(this.moveCounter+=this.undoing?-1:1),(0===c.degrees||c.isShuffle)&&b.purge(c),this.immediateTwist(c))),this.mouseInteraction.enabled=this.mouseControlsEnabled&&!this.finalShuffle,this.mouseInteraction.update(),this.controls.enabled=this.mouseControlsEnabled&&!this.mouseInteraction.active,this.controls.update())}}()});ERNO.Solver=function(){this.logic=function(a){return!1}};ERNO.Solver.prototype.consider=function(a){if(void 0===a)return console.warn("A cube [Cube] argument must be specified for Solver.consider()."),!1;if(!1===a instanceof ERNO.Cube)return console.warn("The cube argument provided is not a valid Cube."),!1;a.isShuffling=!1;return a.isSolved()?(ERNO.Solver.prototype.explain("I\u2019ve found that the cube is already solved."),!1):this.logic(a)};
